/*
   Let coins have a limited lifetime. Remove after a while. This allows us to compensate for score changes (probability of negative or positive coins).
   When hitting score 404, end the game 
    ...
    addCoin() {
        if (this.coins.length < 20) {
            ...
            if (!road.hasCoin) {
                ...
                var coin = Coin(Math.round(coinX), Math.round(coinY), statusCode.value);
